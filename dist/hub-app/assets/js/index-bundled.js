...
var dentist_id_in_dentacoin_db = 70134;
var is_hybrid;

var api_requests = {
    get_default_apps: function (callback) {
        $.ajax({
            type: 'GET',
            url: 'https://hub-app-api.dentacoin.com/internal-api/get-default-applications',
            dataType: 'json',
    ...
    get_default_apps_which_dentist_dont_have_yet: function (id, callback) {
        $.ajax({
            type: 'GET',
            url: 'https://hub-app-api.dentacoin.com/internal-api/get-default-applications-which-dentist-dont-have-yet/'+id,
            dataType: 'json',
            success: function(response) {
                callback(response);
            }
    ...
    get_deleted_apps_for_dentist: function (id, callback) {
        $.ajax({
            type: 'GET',
            url: 'https://hub-app-api.dentacoin.com/internal-api/get-deleted-applications-for-dentist/'+id,
            dataType: 'json',
            success: function(response) {
                callback(response);
            }
    ...
    get_dentist_data: function (callback, id) {
        $.ajax({
            type: 'GET',
            url: 'https://hub-app-api.dentacoin.com/internal-api/get-dentist-data/' + id,
            dataType: 'json',
            success: function(response) {
                callback(response);
            }
    ...
    edit_dentist_data: function (post_data, callback) {
        $.ajax({
            type: 'POST',
            url: 'https://hub-app-api.dentacoin.com/internal-api/edit-dentist-data',
            data: post_data,
            dataType: 'json',
            success: function(response) {
                callback(response);
    ...
    edit_dentist_colors: function (post_data, callback) {
        $.ajax({
            type: 'POST',
            url: 'https://hub-app-api.dentacoin.com/internal-api/edit-dentist-colors',
            data: post_data,
            dataType: 'json',
            success: function(response) {
                callback(response);
    ...
    add_dentist_applications: function (callback, apps_to_be_added) {
        $.ajax({
            type: 'POST',
            url: 'https://hub-app-api.dentacoin.com/internal-api/add-dentist-applications',
            dataType: 'json',
            data: {
    ...
    edit_dentist_application: function(id, post_data, callback) {
        $.ajax({
            type: 'POST',
            url: 'https://hub-app-api.dentacoin.com/internal-api/edit-dentist-application/'+id,
            dataType: 'json',
            data: post_data,
            success: function(response) {
                callback(response);
    ...
    delete_dentist_application: function (callback, id) {
        $.ajax({
            type: 'POST',
            url: 'https://hub-app-api.dentacoin.com/internal-api/delete-dentist-application/'+id,
            dataType: 'json',
            data: {
                token: JSON.parse(window.localStorage.getItem('currentDentist')).token,
                id: JSON.parse(window.localStorage.getItem('currentDentist')).id
    ...
    add_mobile_device_id: function (callback, id) {
        $.ajax({
            type: 'POST',
            url: 'https://hub-app-api.dentacoin.com/internal-api/add-mobile-device-id',
            dataType: 'json',
            data: {
                token: JSON.parse(window.localStorage.getItem('currentPatient')).coredb_token,
                id: JSON.parse(window.localStorage.getItem('currentPatient')).coredb_id,
                mobile_device_id: id
            },
            success: function(response) {
                callback(response);
...
var pages_data = {
    basicAdminPanel: function() {
        ...
        $('.dentist-logo-wrapper #dentist-logo').on('change', function() {
            readURL(this, function(e, filename) {
        ...
        function buildDentistData(dentist_data, build_logo_and_titles, edit_mode) {
            ...
            for(var key in dentist_data.data.applications) {
                ...
                if (dentist_data.data.applications.hasOwnProperty(key)) {
                    ...
                    apps_html += '<div class="'+column_class+' text-center padding-bottom-15 inline-block-top single-app sortable-app '+class_name+'"';
        ...
        $('.pick-dentist-color').click(function() {
            ...
            if (this_btn.attr('data-opened') == 'false') {
                api_requests.get_dentist_data(function(get_dentist_data_response) {
                    ...
                    if (get_dentist_data_response.success) {
                        ...
                        $('.reset-to-default').click(function() {
                            if (resetToDefault) {
                                ...
                                showLoader();
                                api_requests.edit_dentist_colors({
                                    token: JSON.parse(window.localStorage.getItem('currentDentist')).token,
                                    id: JSON.parse(window.localStorage.getItem('currentDentist')).id,
                                    base_color: '#8b2f46',
                                    text_color: '#333',
                                    ...
                                    if (response.success) {
                                        ...
                                        updatePlatformColors(dentist_id_in_dentacoin_db);
                                ...
                                confirm_obj.callback = function (result) {
                                    if (result) {
                                        ...
                                        if (error_messages != '') {
                                            ...
                                            showLoader();
                                            setTimeout(function() {
                                                api_requests.edit_dentist_colors(post_data, function(response) {
                                                    if (response.success) {
                                                        $('body').addClass('overflow-hidden');
                                                        if ($(window).width() < 1000) {
                                                            $('.dentist-logo').show();
            ...
            $('.edit-app').click(function() {
                ...
                $('.add-edit-app-popup .edit-app-action').click(function () {
                    ...
                    if ($('.add-edit-app-popup #app-url').val().trim() == '') {
                        ...
                        setTimeout(function () {
                            api_requests.edit_dentist_application(this_app_id, post_data, function (response) {
                                hideLoader();
                                if (response.success) {
        ...
        api_requests.get_dentist_data(function(response) {
            if (response.success) {
                updatePlatformColors(dentist_id_in_dentacoin_db);
                ...
                $('.edit-page').unbind().on('click', function() {
                    ...
                    $('.single-app .app-wrapper').prepend('<div class="actions-on-edit"><button type="button" class="edit-app platform-color-important"><i class="fa fa-pencil" aria-hidden="true"></i></button><button type="button" class="delete-app platform-color-important"><i class="fa fa-times" aria-hidden="true"></i></button></div>');
                ...
                $('.add-app').unbind().on('click', function() {
                    var this_btn = $(this);
                    api_requests.get_default_apps_which_dentist_dont_have_yet(JSON.parse(window.localStorage.getItem('currentDentist')).id, function(default_apps_response) {
                        api_requests.get_deleted_apps_for_dentist(JSON.parse(window.localStorage.getItem('currentDentist')).id, function(deleted_apps_response) {
                            basic.closeDialog();
                            ...
                            if (default_apps_response.data.length > 0 || deleted_apps_response.data.length) {
                                ...
                                $('.remove-existing-deleted-app').click(function() {
                                    ...
                                    confirm_obj.callback = function (result) {
                                        if (result) {
                                            // remove deleted app
                                            api_requests.delete_dentist_application(function(response) {
                                                if (response.success) {
                            ...
                            $('.add-edit-app-popup .add-app-action').click(function() {
                                ...
                                if (apps_to_be_added.length) {
                                    api_requests.add_dentist_applications(function(response) {
                                        if (response.success) {
                                            api_requests.get_dentist_data(function(get_dentist_data_response) {
                                                if (get_dentist_data_response.success) {
                ...
                $('.save-changes').unbind().on('click', function() {
                    ...
                    confirm_obj.callback = function (result) {
                        if (result) {
                            ...
                            setTimeout(function() {
                                api_requests.edit_dentist_data(post_data, function(response) {
                                    if (response.success) {
                                        api_requests.get_dentist_data(function(get_dentist_data_response) {
                                            if (get_dentist_data_response.success) {
            ...
            $(document).on('click', '.in-app-browser-link', function() {
                ...
                if(currentHref.includes('wallet')) {
                    ...
                    window.plugins.launcher.canLaunch({packageName:'wallet.dentacoin.com'}, function() {
                        ...
                        console.log('wallet app is not installed');
                        // dentacoin wallet app is not installed
                        if(basic.getMobileOperatingSystem() == 'Android') {
                            cordova.InAppBrowser.open('https://play.google.com/store/apps/details?id=wallet.dentacoin.com&hl=en', '_blank', 'location=yes,zoom=no,toolbarposition=top,closebuttoncaption=Back');
                        } else if(basic.getMobileOperatingSystem() == 'iOS') {
                            cordova.InAppBrowser.open('https://apps.apple.com/us/app/dentacoin-wallet/id1478732657', '_blank', 'location=yes,zoom=no,toolbarposition=top,closebuttoncaption=Back');
                        }
                    });
                    ...
                    window.plugins.launcher.canLaunch({packageName:'com.dentacoin.dentacare'}, function() {
                        ...
                        console.log('dentacare app is not installed');
                        // dentacoin dentacare app is not installed
                        if(basic.getMobileOperatingSystem() == 'Android') {
                            cordova.InAppBrowser.open('https://play.google.com/store/apps/details?id=com.dentacoin.dentacare&hl=en', '_blank', 'location=yes,zoom=no,toolbarposition=top,closebuttoncaption=Back');
                        } else if(basic.getMobileOperatingSystem() == 'iOS') {
                            cordova.InAppBrowser.open('https://apps.apple.com/bg/app/dentacare-health-training/id1274148338', '_blank', 'location=yes,zoom=no,toolbarposition=top,closebuttoncaption=Back');
                        }
                    });
                } else {
                    cordova.InAppBrowser.open(currentHref, '_blank', 'location=yes,zoom=no,toolbarposition=top,closebuttoncaption=Back');
                }
            });
        }
    }
                ...
                if (is_hybrid) {
                    window.FirebasePlugin.hasPermission(function(hasPermission) {
                        if(basic.property_exists(hasPermission, 'isEnabled') && hasPermission.isEnabled) {
                            ...
                            api_requests.add_mobile_device_id(function() {
...
function admin_router() {
    ...
    $('body').on('DOMSubtreeModified', '.admin-main-content', function() {
        if ($('app-basic-admin-panel').length && current_route != 'basic-admin-panel' && window.localStorage.getItem('currentDentist') != null) {
            ...
            pages_data.basicAdminPanel();
        } else if ($('app-advanced-admin-panel').length && current_route != 'advanced-admin-panel' && window.localStorage.getItem('currentDentist') != null) {
            $('body').removeClass('platform-background');
            current_route = 'advanced-admin-panel';
            pages_data.advancedAdminPanel();
...
function initLoggedInWrapperLogic() {
    ...
    if (add_overflow_hidden_on_hidden_box_show) {
        $('.logged-user-right-nav .hidden-box-parent').unbind().on('click', function() {
            $('.logged-user-right-nav .hidden-box').toggleClass('show-this');
            if (!sm_screen_width || (!$('app-my-wallet').length && !$('app-edit-account').length && !$('app-manage-privacy').length)) {
        ...
        $(document).on('mouseenter', '.logged-user-right-nav .hidden-box-parent', function() {
            $('.logged-user-right-nav .hidden-box').addClass('show-this');
            $('.logged-user-right-nav .up-arrow').addClass('show-this');
        });
        $(document).on('mouseleave', '.logged-user-right-nav .hidden-box-parent', function() {
            $('.logged-user-right-nav .hidden-box').removeClass('show-this');
            $('.logged-user-right-nav .up-arrow').removeClass('show-this');
        });
    }

    $('.logged-user-right-nav .close-btn a').unbind().on('click', function() {
        $('.logged-user-right-nav .hidden-box').removeClass('show-this');
        if (add_overflow_hidden_on_hidden_box_show) {
            $('body').removeClass('overflow-hidden');
...
function showLoader(message) {
    ...
    $('.camping-loader').html('<div class="response-layer"><div class="wrapper"><figure itemscope="" itemtype="http://schema.org/ImageObject"><img src="assets/images/loader.gif" class="max-width-160 width-100" alt="Loader"></figure><div class="message lato-bold fs-24">'+message+'</div></div></div>');
    $('body').addClass('overflow-hidden');
    $('.response-layer').show();
}
...
function readURL(input, callback, failed_callback) {
...
function updatePlatformColors(id) {
    api_requests.get_dentist_data(function(get_dentist_data_response) {
        if (get_dentist_data_response.success) {
...
function refreshCaptcha() {
    $.ajax({
        type: 'GET',
        url: 'http://hub-app-api.dentacoin.com/refresh-captcha',
        dataType: 'json',
        success: function (response) {
