...
var clickingOutsudeSearchResultInit = true;
...
var pages_data = {
    ...
    myWallet: function() {
        ...
        if (clickingOutsudeSearchResultInit) {
            clickingOutsudeSearchResultInit = false;
            ...
            $('.search-body ul li button').click(function() {
                ...
                delete_address_book_wallet_address.callback = function (result) {
                    if (result && !ajaxSent) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'https://hub-app-api.dentacoin.com/internal-api/delete-address',
                            data: {
                                token: JSON.parse(window.localStorage.getItem('currentPatient')).coredb_token,
        ...
        $('.search-result .search-footer .add-to-address-book').click(function() {
            ...
            $('.save-to-address-book').click(function() {
                if($('.popup-save-to-address-book #contact-name').val().trim() == '') {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'https://hub-app-api.dentacoin.com/internal-api/save-address',
                        data: {
                            name: addressName,
